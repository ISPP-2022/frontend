...
function Selection(props) {
  ...
  return (
    <div className="h-screenC md:bg-gray-100 flex justify-center items-center">
      ...
      <main className="md:bg-white p-4 md:h-[75vh] md:w-2/3 md:mt-3 md:min-h-[440px] md:min-w-[600px] md:rounded-xl md:border-2 md:border-[#4aa7c0] flex flex-col">
        ...
        <nav className="grid grid-cols-1 md:flex md:justify-center md:flex-row md:space-x-9 h-full md:items-center space-y-6 md:space-y-0">
