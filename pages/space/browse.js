                ...
                <div id="form" className="md:max-w-[95%] rounded-xl border-2 mb-8 border-[#4aa7c0] ">
                    <form onSubmit={addObject}>
                        <div className="flex flex-col md:flex-row items-center justify-center">
                            <select id="category" className="form-select appearance-none border border-solid border-[#4aa7c0] rounded transition ease-in-out m-5 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none">
                                {dataTypes.map(obj => {return (<option value={obj} >{obj}</option>)})}
                            </select>

                            <select id="size" className="form-select appearance-none border border-solid border-[#4aa7c0] rounded transition ease-in-out m-5 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none">
