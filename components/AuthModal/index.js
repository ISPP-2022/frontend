            ...
            <form className=" w-2/3 md:w-full px-6 md:px-10 space-y-[2vh]">
              ...
              <div className="relative">
                ...
                <div class="absolute inset-y-0 right-0 flex items-center px-2">
                  <input class="hidden js-password-toggle" id="toggle" type="checkbox" value={showPassLogin} onChange={(e) => setShowPassLogin(e.target.checked)} />
          ...
          <div className="flex flex-col justify-center items-center w-full">
            <form className=" w-2/3 md:w-full px-6 md:px-10 space-y-[2vh]">
              ...
              <div className="relative">
                ...
                />
                <div class="absolute inset-y-0 right-0 flex items-center px-2">
                  <input class="hidden js-password-toggle" id="toggle" type="checkbox" value={showPassRegister} onChange={(e) => setShowPassRegister(e.target.checked)} />
                  <label class=" hover:bg-gray-400 rounded p-1 text-sm text-gray-600 font-mono cursor-pointer js-password-label" for="toggle">
                    {
                      showPassRegister ?
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
