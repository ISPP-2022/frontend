  ...
  return (
    <>
      <div className="fixed inset-0 mt-4 z-50">
        ...
        <div className="fixed block top-1/2 left-1/2 w-full h-full sm:w-[30rem] sm:h-3/4 min-h-[350px] bg-white -translate-x-1/2 -translate-y-1/2 sm:border-webcolor-50 sm:border-2 sm:rounded-sm sm:my-4 sm:mx-4 justify-center">
